...
async def slash_command(interaction:discord.Interaction):
    help_embed = discord.Embed(title="Movix help desk.", description="A list of commands for the Movix bot", color=0xffffff)
...
async def slash_command(interaction:discord.Interaction, movie_name:str):
    ...
    if (movies_status==-1):
        ...
        for movie in movies:
            #get the torrents infos and piopulate the select var
